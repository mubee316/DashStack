  ...
  return (
    <div className="min-w-[12rem]  min-h-full bg-white shadow-2xl  overflow-y-scroll scrollbar border  h-screen fixed top-0 left-0">
      ...
      <div className="flex flex-col p-5 gap-1 ">
        <Link className="flex items-center gap-2 px-4 py-2 text-sm text-white bg-blue-700 rounded-md"
        href="/">
          <FaClock />
          Dashboard
        </Link>
        <Link href="/Products/pages" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 ">
          <FaBox />
          Products
        </Link>
